...
router
  ...
  .put(authToken, getAvatarAssets, upload.single("avatar"), updateAvatarImage);

router.route("/getChannelProfile/:username").get(authToken, getUserProfile);

router.route("/deleteWatchHistory").delete(authToken, deleteWatchHistory);
